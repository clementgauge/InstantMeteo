...
export const GigaBulletinView: React.FC<GigaBulletinViewProps> = ({
  ...
  return (
    <div id="giga-bulletin-hub-view" className="space-y-6">
      ...
      <div className="rounded-3xl border border-slate-800 bg-slate-900/90 p-4 sm:p-5 shadow-2xl backdrop-blur flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2 p-1.5 bg-slate-950 rounded-2xl border border-slate-800">
          ...
          >
            ...
            <span>1. 🇫🇷 Bulletin 4 Semaines par Commune (Toutes Communes)</span>
          </button>
          ...
          >
            ...
            <span>2. Bulletin J+1 à J+7 par Département (101 Dép. & Monde)</span>
          </button>
          ...
          >
            ...
            <span>3. Bulletin National & Régional 4 Semaines (S+1 à S+4)</span>
          </button>
        </div>
      </div>
